    ...
    return (
        <div className="diary-detail space-y-4">
            ...
            <div>
                ...
                <div className="p-3 text-black focus:outline-none bg-white border-lightgray border rounded-xl">{diary.title}</div>
            </div>
            <div>
                <p className="mb-2">내용</p>
                <div
                    className="p-3 text-black focus:outline-none bg-white border-lightgray border rounded-xl"
